class Solution {
	public int minMovesToMakePalindrome(String s) {
        // Explaination
        // https://leetcode.com/problems/minimum-number-of-moves-to-make-palindrome/discuss/1823173/Java-C%2B%2B-2-pointers.-Step-by-step-dry-run-for-easy-explanation
	...
	private int findKthIndexMatchingwithLthIndex(char[] strArr, int l, int k){
		while(k > l){
